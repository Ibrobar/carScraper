...
//
// Ids 003-007 are deliberately absent: they belong to the CRM module, which
// lives on the `feature/crm` branch. Databases that have run the CRM already
// recorded them and are unaffected; this branch simply never creates the tables
// they alter. Do not reuse those numbers.
const MIGRATIONS = [
